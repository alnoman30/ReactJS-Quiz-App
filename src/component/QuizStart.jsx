          ...
          <div className="text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto">
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="flex items-start">
                ...
                <span>Once you select an answer, You'll see the explaination</span>
              </li>
              <li className="flex items-start">
                <span className="shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5">
                  4
                </span>
                <span>You can navigate to previous questions</span>
              </li>
            </ul>
          </div>
        </div>

        <button className="inline-flex items-center space-x-3 py-4 px-8 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transform-all duration-200 shadow-lg fornt-semibold text-lg cursor-pointer">
          <Play size={24}/>
